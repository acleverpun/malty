...
public final class Containers {
	...
	public static final RegistryObject<ContainerType<AggregatorContainer>> aggregator = registry.register("aggregator", () -> IForgeContainerType.create(AggregatorContainer::new));
