...
public class AggregatorScreen extends ContainerScreen<AggregatorContainer> {
	public AggregatorScreen(final AggregatorContainer container, final PlayerInventory inventory, final ITextComponent title) {
